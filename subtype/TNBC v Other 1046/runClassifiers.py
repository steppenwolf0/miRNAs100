...
def loadDataset() :
	...
	dfData = read_csv("./data/dataTest.csv", header=None, sep=',')
	dfLabels = read_csv("./data/labelsTest.csv", header=None)
	...
	for originalClassifier, classifierName in classifierList :
		...
		for train_index, test_index in indexes :
			...
			if False :
				...
				class4 = [ (y == classValue) for y in y_test ]
				...
				ax.plot(X_pca_test[class4,0], X_pca_test[class4,1], 'r.', label=name+" data")
